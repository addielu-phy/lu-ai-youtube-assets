...
SEGMENT_TITLES = [
    '45 分鐘 AI 物理探究課，不是把 AI 放進去就好',
    '第 1 段：先用現象與問題啟動探究',
    '第 2 段：AI 只能當草稿，學生要改寫假設',
    '第 3 段：用證據表與追問檢查答案',
    '收尾：把 AI 回答變成可被退件的學習成果',
]
...
new_mp4 = OUT / 'ai-physics-inquiry-class-slide-video-draft-lu-f5tts-v1.mp4'
...
draw.text((50, 28), 'AI 物理探究課｜Lu F5-TTS v1 QA contact sheet', font=title_font, fill=(32, 45, 62))
...
manifest.update({
    ...
    'next_auto_push': 'Continue voice remediation queue with shorts/hypothesis-causal-variable-20260513, or upload Lu voice versions after YouTube/Google login.'
})
...
archive = OUT / 'ai-physics-inquiry-class-lu-f5tts-v1-kit-20260517.tar.gz'
members = [
    ...
    new_mp4, OUT / 'ai-physics-inquiry-class-slide-video-draft-v1.mp4', OUT / 'youtube-upload-kit-longform-v1.md', OUT / 'ai-physics-inquiry-class-shareable-handout-v1.md', qa,
