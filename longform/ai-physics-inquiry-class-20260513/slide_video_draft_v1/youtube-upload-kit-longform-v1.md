# YouTube upload kit｜一堂 45 分鐘 AI 物理探究課怎麼排？
...
## 搭配講義
- 正式可分享／Google Docs-ready 講義：`ai-physics-inquiry-class-shareable-handout-v1.md`
- 建議貼在說明欄或留言：這份講義可作為 45 分鐘 AI 物理探究課的流程單；公開使用前請先移除學生個資、未授權圖片與未公開題目。
