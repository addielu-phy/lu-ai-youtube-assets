...
def write_docs(total):
    ...
    manifest={
        ...
        'next_auto_push': '製作正式可分享／Google Docs-ready AI 物理探究課流程講義，並更新輕量上架交接包；若 YouTube/Google 登入完成，優先上傳第一季首批或本支第三季長片草稿。'
    }
...
def make_archive():
    ...
    members = [
        ...
        OUT/'checks/contact_sheet_slide_video_v1.png', OUT/'youtube-upload-kit-longform-v1.md',
