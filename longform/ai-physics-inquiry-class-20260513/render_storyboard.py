...
('把 45 分鐘變成可重用教案模板','最後留下的不是一份答案，而是一套之後每班都能複製的 AI 探究流程。',[{'head':'流程表','body':'5 情境、10 假設、15 資料、10 退件、5 Exit Ticket。','color':BLUE},{'head':'學生紀錄表','body':'預測、證據、AI 建議、我採納／不採納的理由。','color':PURPLE},{'head':'公開前提醒','body':'學生作品、截圖、真實資料與未公開教材，發布前仍需人工確認。','color':GREEN}],'下一步可自動推進：第三季優先題 5 storyboard 已完成；改把該 storyboard 擴成 35 秒 Shorts MP4 與圖片授權檢查表。')]
