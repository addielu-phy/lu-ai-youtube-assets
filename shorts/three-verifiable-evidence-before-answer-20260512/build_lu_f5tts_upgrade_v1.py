...
import subprocess, json, tarfile, textwrap
from PIL import Image, ImageDraw, ImageFont

PKG = Path('/home/adl/youtube-lu-ai-channel/shorts/three-verifiable-evidence-before-answer-20260512')
...
chunks = [
    'AI 給答案很快，但老師先別急著看結論。',
    '請學生加一句：回答前，先列出三個可驗證證據。',
    '第一個，現象：我看得到什麼？第二個，數據：我量得到什麼？第三個，原理：它支持哪一句答案？',
    '接著讓 AI 標明每個證據怎麼檢查。',
    '這樣學生不是抄答案，而是在判斷：答案漂亮，有沒有證據撐住。',
]
...
old_mp4 = PKG / 'three-verifiable-evidence-before-answer-shorts-35s.mp4'
new_mp4 = PKG / 'three-verifiable-evidence-before-answer-shorts-35s-lu-f5tts-v1.mp4'
...
segments = [
    (0.0, 5.0, 'AI 給答案很快，但老師先別急著看結論。'),
    (5.0, 10.5, '回答前，先列出三個可驗證證據。'),
    (10.5, 15.5, '現象、數據、原理，三個證據要分開看。'),
    (15.5, 26.5, '接著讓 AI 標明每個證據怎麼檢查。'),
    (26.5, 35.0, '答案漂亮不夠，學生要能判斷有沒有證據撐住。'),
]
...
imgs = [Image.open(PKG/'cover_three_verifiable_evidence_v1.png').convert('RGB')] + [Image.open(CHECKS/n).convert('RGB') for n in frame_names]
