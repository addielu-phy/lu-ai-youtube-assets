...
若 YouTube/Google 登入仍未完成：本 storyboard 已擴成 35 秒 Shorts MP4／封面／字幕／YouTube upload kit，並延伸一頁「補救雙鎖」教師檢查表；下一輪改從第三季題庫挑選下一個尚未完成 storyboard／講義延伸。  
若使用者已完成 YouTube/Google 登入：優先上傳已完成的第一季首批或本支第三季 Shorts。
'''
