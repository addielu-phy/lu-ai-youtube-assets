...
PKG = Path('/home/adl/youtube-lu-ai-channel/shorts/image-license-check-before-slide-20260513')
...
chunks = [
    'AI 找到的圖，可以直接放簡報嗎？先不要急。',
    '我會請學生和 AI 一起做三查。',
    '第一查來源：這是網站、教材、截圖，還是 AI 生成？',
    '第二查授權：能不能公開、改作、商用？不確定就不上網。',
    '第三查替代：授權不清楚，就改成自畫示意圖、表格，或文字描述。給 AI 的句子是：請列出來源、授權狀態，和一個自製替代方案。',
]
...
old_mp4 = PKG / 'image-license-check-before-slide-shorts-35s.mp4'
new_mp4 = PKG / 'image-license-check-before-slide-shorts-35s-lu-f5tts-v1.mp4'
...
segments = [
    (0.0, 5.0, 'AI 找到的圖，可以直接放簡報嗎？先不要急。'),
    (5.0, 9.0, '我會請 AI 和學生一起做三查。'),
    (9.0, 16.5, '第一，來源：網站、教材、截圖，還是 AI 生成？要寫清楚。'),
    (16.5, 24.5, '第二，授權：能否公開、改作、商用？不確定就不要放上網。'),
    (24.5, 35.0, '第三，替代方案：改成自製示意圖、表格，或留下文字描述。'),
]
...
imgs = [Image.open(PKG/'cover_image_license_check_v1.png').convert('RGB')] + [Image.open(CHECKS/n).convert('RGB') for n in frame_names]
...
manifest.update({
    'status': '35s Shorts MP4/upload kit/image-license checklist complete; Lu Teacher F5-TTS v1 voice upgrade ready',
