...
manifest.update({
    ...
    'published':{'github_pages_index':'https://addielu-phy.github.io/lu-ai-youtube-assets/mobile-index/index.html','github_pages_commit':'02e7a09','verified':'content pushed; cleanup/live verification pending'}
})
