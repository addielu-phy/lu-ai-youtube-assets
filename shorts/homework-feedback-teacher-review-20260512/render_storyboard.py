...
(5,'收尾 CTA','貼回饋前，先問一句：\n學生看完知道下一步嗎？','已延伸：35 秒影片、字幕、上傳包，以及「回饋審稿檢查表」。','盧老師 × AI 物理教學',CYAN,diag5),]
...
狀態：第二季優先題 11 已完成 5 張 1080×1920 storyboard 圖卡；後續已由 build_shorts_mp4_upload_kit.py 擴成 35 秒 MP4／upload kit／教師檢查表。
...
## 下一個可自動推進項目
若 YouTube/Google 登入仍未完成，下一輪從第二季尚未完成優先題 6 或 12 挑下一支 storyboard／講義延伸。
"""
(BASE/'README.md').write_text(readme, encoding='utf-8')
manifest={'title':'AI 幫忙回饋作業，老師不能跳過哪一步？','season_priority':11,'status':'storyboard_complete_mp4_upload_kit_generated_by_build_script','created':'2026-05-12','files':[str(p.relative_to(BASE)) for p in paths]+['checks/contact_sheet.png','README.md','manifest.json','render_storyboard.py'],'next_auto_push':'choose the next unmade season-02 backlog item (priority 6 or 12) or upload completed Shorts after YouTube login is ready','verification':{'slide_dimensions':'5 slides 1080x1920 RGB','contact_sheet':'1120x1440 RGB','vision_qa':'passed: Traditional Chinese readable, no tofu/cropping/overlap/overcrowding'}}
